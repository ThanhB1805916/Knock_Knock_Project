...
public class LoginController implements Initializable {
	...
	*-----------------------------------------------------------------------------------*/
	...
	public void signinButton_Pressed(MouseEvent event){
		if(checkIsValid(usernameSignin.getText()) && checkIsValid(passwordSignin.getText()) && passwordSignin.getText().equals(confirmPasswordSiginin.getText()) && checkIsValid(nameSignin.getText()) && checkIsValid(phoneSignin.getText())){
