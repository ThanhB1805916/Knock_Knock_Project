...
-- SELECT * FROM Message WHERE id_room = 1;
-- -----------------------------------------------------------------------------------------------------------------------------------------------------------
-- ---------------------------------------------------------------------- Get
...
delimiter //
CREATE PROCEDURE spMessage_InsertMessage(in id_room int, in id_person int, in messagecontent varchar(128), isFile BOOL, sendtime DATETIME)
begin
...
delimiter ;
 ...
 -- CALL spMessage_InsertMessage(1, 1, 'Ola', '1', now());
-- CALL spMessage_InsertMessage('1', '1', 'AA', 'TRUE', '2020-11-09T21:39:36.199245100');
-- -----------------------------------------------------------------------------------------------------------------------------------------------------------
-- ---------------------------------------------------------------------- Update
-- Sửa tin nhắn
use knock_knock_project_test;
...
delimiter //
CREATE PROCEDURE spMessage_UpdateMessage(in id int, in messagecontent varchar(128), isFile boolean)
begin
update message 
