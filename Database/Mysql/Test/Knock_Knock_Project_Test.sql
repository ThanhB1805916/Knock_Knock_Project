...
DROP DATABASE Knock_Knock_Project_Test; 

CREATE DATABASE Knock_Knock_Project_Test;
...
(
    ...
    gender BOOL NOT NULL DEFAULT '0', -- Giới tính 1 là nam 0 là nữ
...
(
    ...
    isFile BOOL NOT NULL DEFAULT '0', -- Kiểm tra file mặc định là tin nhắn
