...
public class HandlerFactory {
	...
	public void createHanlder(Client client, CPackage CPackage) {
		...
		if (CPackage.isValid()) {
			...
			case AUTHENTICATION:
				Handler = new AuthenticationHandlerImp(DAOFactory.getPersonDAO());
				break;

			case ACCOUNT:
				Handler = new AccountHandlerImp(DAOFactory.getPersonDAO());
				break;
...
//				Handler = new FriendHandlerImp(client, DAOFactory.getPersonDAO());
			...
			case ROOM:
				Handler = new RoomHandlerImp(DAOFactory.getRoomDAO());
				break;

			case MESSAGE:
				Handler = new MessageHandlerImp(DAOFactory.getMessageDAO());
				break;
			...
			if (Handler != null)
				Handler.handleRequest(client, CPackage.getRequest());
			else
