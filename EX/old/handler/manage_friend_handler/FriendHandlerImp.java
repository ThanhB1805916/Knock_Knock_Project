...
//	// --------------------------------------------------------------------------------------------------------------------------------------------
//
//	public FriendHandlerImp(IClient client, PersonDAO dao) {
//		super(client);
//		this.dao = dao;
//	}
//
...
//		List<Person> friendList = new PersonConverter().convert(dao.getListByID_Friend(authorizedClientList.get(client).getId()));
//		return friendList;
//	}
//
//	@Override
